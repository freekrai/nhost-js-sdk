...
var Auth = /** @class */ (function () {
    function Auth(config, session) {
        var baseURL = config.baseURL, useCookies = config.useCookies, refreshIntervalTime = config.refreshIntervalTime, clientStorage = config.clientStorage, clientStorageType = config.clientStorageType, ssr = config.ssr, autoLogin = config.autoLogin;
    ...
    Auth.prototype.changeEmail = function (new_email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.post("/change-email", {
                            new_email: new_email,
                        }, {
    ...
    Auth.prototype.requestEmailChange = function (new_email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.post("/change-email/request", {
                            new_email: new_email,
                        }, {
                            headers: this._generateHeaders(),
                        })];
    ...
    Auth.prototype.MFAGenerate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.post("/mfa/generate", {}, {
                            headers: this._generateHeaders(),
                        })];
                    case 1:
                        res = _a.sent();
